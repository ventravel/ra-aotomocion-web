...
// Extrae matrícula, vehículo, km, fecha, cliente, teléfono y los avisos
// (ITV + catálogo de trabajos) de una factura emitida por el propio taller (CSS).
function extraerDatosFactura(texto, catalogo) {
